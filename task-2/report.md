### Tools used
ChatGPT Plus plan, Lovable Pro plan(100 monthly credits)

### Techniques
I used ChatGPT to generate plan, prompts and phases to use it later in Lovable

`make detailed plan for the Lovable app. Split it to phases, prompts and use it to generate app`
